...
extern "C"
{
    ...
    void*   haisql_get_thread_local_ptr( void* ptr_void_key_in )  noexcept;
    void     haisql_add_thread_local_ptr( void* ptr_void_key_in, void* ptr_void_value_in )  noexcept;
    void     haisql_destroy_thread_local_ptr( void* ptr_void_key_in, void(*destructor_in)(void*) )  noexcept;
}
